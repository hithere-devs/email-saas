        ...
        <section className="space-y-8">
          ...
          <div>
            ...
            <div className="space-y-4">
              <p>
                Our platform provides an advanced email client with integrated
                AI capabilities designed to enhance your email management and
              ...
              <ul className="list-disc space-y-2 pl-6">
                ...
                <li>
                  Premium features including advanced AI capabilities and
                  priority support
                </li>
              </ul>
            </div>
          ...
          <div>
            ...
            <div className="space-y-4">
              <p>
                All rights, title, and interest in and to the Service are and
                will remain the exclusive property of our company and its
                licensors.
              </p>
              <ul className="list-disc space-y-2 pl-6">
                <li>Users retain ownership of their email content and data</li>
                <li>
                  AI-generated content is provided under a limited license
                </li>
          ...
          <div>
            ...
            <div className="space-y-4">
              <p>
                ...
                uninterrupted access. The service depends on third-party
                providers including:
              </p>
              <ul className="list-disc space-y-2 pl-6">
