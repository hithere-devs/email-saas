...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative z-0 flex w-full flex-col items-center justify-center rounded-md bg-slate-950",
        className,
      )}
    >
      <div className="relative isolate z-0 flex w-full flex-1 translate-y-56 scale-y-125 items-center justify-center">
        <motion.div
